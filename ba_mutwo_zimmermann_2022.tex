...
Kapitel \emph{\nameref{abstractBaseClasses}} beschreibt, wie \emph{mutwos} Parameter individuelle Repräsentationen ermöglichen.
...
%%%%%%%%%% Nach diesem notebook kann kurze erklaerung ueber dynamische attribute erfolgen, und dann zweiter teil 
%%%%%%%%%% desselben notebooks, wo erklaert wird, ok, vielleicht will man zwischendrin auch noch einfach einen
%%%%%%%%%% bestimmten ton haben, dann fuegt man einfach simpleevent hinzu und gibt dem einfach direkt ein pitch attribut
...
Seit Python 3.6 werden aber optionale Annotationen der Datentypen unterstützt.
...
Das mag einer frühzeitigen Vermeidung bestimmter Fehler helfen.
...
Die Benennung ist einerseits in Konventionen der Sprache Python verursacht (z.~B. \emph{camel case} Klassennamen).
...
Die Begründung für die ausschweifende und strenge Benennung entspricht der für die \emph{\nameref{typeAnnotations}}.
Möglichst eindeutig und klar für Dritte zu sein wird deswegen als wichtiger empfunden als ein reduzierter Text.
