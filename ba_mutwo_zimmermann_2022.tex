...
{\large 19. September 2022}\\[2cm] % Date, change the \today to a set date if you want to be precise
...
\vspace{-1cm}
\hspace{2cm}                   \hfill \includegraphics[scale=0.2]{pictures/e-signature.png} \hspace{2cm}
...
\begin{table}[h!]
    \begin{center}
        \begin{tabular}{l l} 
            ...
            % XXX: Skip this because it's not really clear
            % Lautstärke & Volt(?) \\ [1ex] 
            \hline
        \end{tabular}
    \end{center}
...
\begin{enumerate}
    ...
    \item{
            ...
            Weil entsprechend der \emph{\nameref{motivationUndAbsicht}} die Bibliothek \emph{mutwo} plattformübergreifend verwendbar sein soll, ist eine unterliegende Technologie notwendig, die das unterstützt.
    }
\end{enumerate}
...
\begin{center}
    \fbox{\includegraphics[page=1,scale=0.86]{jupyter/Globale_Voreinstellungen.pdf}}
\end{center}
...
% XXX: Leider kein Raum mehr :( Das sprengt den Umfang :(
%      ...beim nächsten Mal!
...
% XXX: Weiß nicht wo ich diese beiden Sätze hinpacken soll. Sind irgendwie so sinnlos.
...
% Die Mehrheit des Quelltextes ist aber 
...
% Diese werden den Ereignissen (die später zur Notation der Instrumente übersetzt werden) zugewiesen.
% Dritte Programmkomponente können mit den Ereignissen (in ihrem klanglichen Resultat) umgehen, z.~B. können Simulationen der Instrumentalstimmen mit eine MIDI Übersetzer erzeugt werden oder dritte Übersetzer generieren aus ihnen Stimmen für Klangdateien.
% 
...
% XXX: omit for now..there's already enough content
% \bigskip
...
Wie in Abschnitt \emph{\nameref{limitsAndBorders}} beschrieben, sind nicht technische Kompatibilitätsschwierigkeiten oder Unzulänglichkeiten des Designs dafür verantwortlich, sondern die Abwesenheit einer Notwendigkeit gegenwärtiger Nutzer:innen.
...
% Ankerpunkte könnten sein: (1) \emph{Benutzerspezifische Parameter: Tonhöhe und Rhythmus}, (2) \emph{Ereignisse: Melodien, Sequenzen, Noten}, (3) \emph{Export von Ereignisse in MIDI Dateien und Notation}, (4) \emph{Benutzerspezifischer Export von Ereignisse: Kepathian} und (5) \emph{Definition interner Algorithmen}.
Letztlich wäre eine Übersetzung aller dokumentarischen Texte ins Englische erstrebenswert.
Denn nur eine Internationalisierung kann die in \emph{\nameref{limitsAndBorders}} beschriebene Diversität erzielen.
...
% die versucht sich initial frei zu machen von bestimmten Protokollen, Traditionen, Technologien, um die Entscheidung explizit.

% von klanglichen und sozialen Situationen und nicht von Notationstraditionen und Protokolle und Technologien auszugehen.

% Und jetzt vielleicht noch etwas über deine künstlerische Arbeit mit "mutwo"?
%
%     - bis jetzt: Arbeit mit mutwo war produktiv gewesen. Seitdem ich Ende 2021 damit angefangen habe, ist jede kompositorische Arbeit
%       mit mutwo enstanden
%     - meine Interessen verändern sich mit der Zeit => das was ich von mutwo möchte, verändert sich damit auch
%     - musikalische Praxis ist nicht nur Instrumente spielen auf der Bühne, sondern..
%           -> komponieren -> Instrumentenbau -> Architektur -> Veranstaltungen -> Programmierung
%         -> dh. selbst wenn ich aufhöre algorithmische Komposition zu machen, mag algorithmische Kompositionssoftware noch immer Teil einer Praxis sein
