...
Entwickler:innen werden nicht zur Verwendung bestimmten Formen spezifischer Ereignisse (z.~B. Pause, Akkord, Note) gezwungen.
...
Die Ereignisbasisklassen sind die in Kapitel \emph{\nameref{eventDefinitions}} beschriebenen Klassen \texttt{SimpleEvent}, \texttt{SequentialEvent} und \texttt{SimultaneousEvent}~\footnote{%
    Übersetzer und andere \emph{mutwo} Objekte benötigen Basisklassen, um Blätter eines Ereignisbaums erkennen zu können und um zwischen akkumulierenden und parallelen Ereignisbehälter unterscheiden zu können.
...
Die Abwesenheit spezifischer Ereignisklassen ist mithilfe Pythons Unterstützung von Introspektion, dynamischen Attributen und anonymen Funktionen gelöst.
