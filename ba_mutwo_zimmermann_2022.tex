...
% Zwar geteilte Programmstruktur und Rahmenbedingungen, aber letztenendes doch sehr unterschiedliche Arbeiten:
%
%   oT2:   gerichtete Zeit
%           - irreversible Ereignisse
%
%   oT3: ungerichtete Zeit
%           - pendeln


% Mutwo hints:
%
%   - es gibt ein Modell (Ereignisse, Übersetzer, etc.), in das ein Konzept eingebettet / realisiert werden kann.
%   - Flexible Struktur (synchron vs. asynchron). 
%   - Elektronik und Instrumente benutzen gleiche Daten, sind gleich erzeugt und vermischen sich deswegen sehr gut
