...
%
% 2. Ich wollte zuerst nur Sinusoide erzeugen. Aber wegen allgemeiner Struktur konnte ich dann einfach auch direkt MIDI Dateien und ISIS erzeugen etc.
%
% 2. (b) So konnte ich auch schnell Reaper Marker Dateien erzeugen, mit denen ich die Gruppen kontrollieren konnte und ein Gefühl für die globalen
%        Entscheidungen bekommen konnte.
%
% 3. Weil mutwo in python geschrieben ist und python populär ist konnte ich direkt und easy die constraint-programming bibliothek von google benutzen :)
%    Das hat die Aufgabe sehr viel erleichtert.
