...
Abbildung \ref{fig:mutwoStructure} verdeutlicht die Beziehungen der unterschiedlichen Kategorien zueinander.
...
Entscheidungen expliziter Start-- und Endzeiten trifft in Klangdateien ein (Pseudo--)Zufallsgenerator.
...
Es werden nicht einzelne musikalische Identitäten wie Rhythmen oder Harmonien erzeugt, die anschließend händischen kompositorisch in eine Form gebracht werden.
...
\emph{\nameref{limitsAndBorders}} \emph{mutwos} sind aber nicht technische Kompatibilitätsschwierigkeiten oder Unzulänglichkeiten des Designs, sondern die Abwesenheit einer Notwendigkeit gegenwärtiger Nutzer:innen.
