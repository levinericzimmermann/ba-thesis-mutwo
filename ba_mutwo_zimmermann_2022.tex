...
Musiker:innen können autonom entscheiden, wann sie innerhalb gegebener Abschnitten notierte Klänge beginnen und beschließen.
...
Der Quellcode zum Erzeugen der Notation, Videos und Klangdateien von \emph{ohne Titel (2)} und \emph{ohne Titel (3)} ist ähnlich organisiert.
Abbildung \ref{fig:ohneTitelMutwoStructure} verdeutlicht schematisch die Organisation.
